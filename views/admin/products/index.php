              ...
              <form action="opsi-products.php" method="POST">
                <div class="container col mb-4">
                  <div class="p-1 row">
                    ...
                    <div class="mb-3 col-4">
                      <label for="domain" style="font-size:15px;" class="mb-1">Domain</label>
                    ...
                    <div class="mb-3 col-4">
                      <label for="penyimpanan" style="font-size:15px;" class="mb-1">Penyimpanan</label>
                    ...
                    <div class="mb-3 col-4">
                      <label for="free_ssl" style="font-size:15px;" class="mb-1">Free_SSL</label>
