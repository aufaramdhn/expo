...
$active = 'order';
include '../sidebar.php';
$orders = mysqli_query($koneksi, "SELECT * FROM transaksi JOIN user ON (user.id = transaksi.id_user) JOIN product ON (product.id_product = transaksi.id_product)");
          ...
          <tr class="text-center">
            ...
            <td>
              <a button class="btn" data-bs-toggle="modal" data-bs-target="#bgambar<?= $no ?>">
                <img src="../../bukti/<?= $order['bukti'] ?>" alt="" width="60" height="40">
              </a>
            </td>
            <td><a button class="btn btn-sm btn-success " href="../../materi/<?= $order['materi'] ?>" download="../../materi/<?= $order['materi'] ?>"><i class="bi bi-download"></i></a>
            </td>
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-body d-flex justify-content-center">
                  <div class="">
                    <img src="../../bukti/<?= $order['bukti'] ?>" alt="" width="450" height="450">
                  </div>
                </div>
              </div>
            </div>
