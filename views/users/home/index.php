        ...
        <header class="bg-light py-5">
            <div class="container px-5">
                <div class="row gx-5">
                    ...
                    <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid my-3" src="../assets/hero-img.png" alt="..." width="400" /></div>
                </div>
            </div>
        </header>
                    ...
                    <div class="col">
                        <div class="row gx-5 row-cols-1 row-cols-md-2 text-center">
                            <div class="col-lg-4 mb-5 h-100">
                                <div class="feature text-white rounded-3 mb-3 p-1"><img class="img-fluid my-3" src="../assets/registered.png" alt="..." width="60px" /></div>
                                <h2 class="h5">Langkah Pertama</h2>
                                <p class="mb-0">Pilih paket pada menu pricing dengan tekan tombol pesan sekarang </p>
                            </div>
                            <div class="col-lg-4 mb-5 h-100">
                                <div class="feature text-white rounded-3 mb-3 p-1"><img class="img-fluid my-3" src="../assets/friends.png" alt="..." width="60px" /></div>
                            ...
                            <div class="col-lg-4 mb-5 mb-md-0 h-100">
                                <div class="feature text-white rounded-3 mb-3 p-1"><img class="img-fluid my-3" src="../assets/credit-card.png" alt="..." width="60px" /></div>
                            ...
                            <div class="col-lg-4 h-100">
                                <div class="feature rounded-3 mb-3 p-1"><img class="img-fluid my-3" src="../assets/folder.png" alt="..." width="60px" /></div>
                                <h2 class="h5">Langkah Keempat</h2>
                                <p class="mb-0">Setekah melakukan pembayaran lalu kirimkan materi untuk isi pada website anda
                                </p>
                            </div>
                            <div class="col-lg-4 h-100">
                                <div class="feature rounded-3 mb-3 p-1"><img class="img-fluid my-3" src="../assets/programing.png" alt="..." width="60px" /></div>
                            ...
                            <div class="col-lg-4 h-100">
                                <div class="feature rounded-3 mb-3 p-1"><img class="img-fluid my-3" src="../assets/denied.png" alt="..." width="60px" /></div>
        ...
        <section class=" my-5 p-3 bg-light">
            <div class="container">
                <div class="text-center mt-4">
                    ...
                    <p class="lead fw-normal text-muted mb-5">Kepuasan Pelanggan Dewarangga</p>
                </div>
                    ...
                    <div class="carousel-inner bg-dark rounded">
                        <div class="carousel-item active rounded p-5 bg-dark text-white" data-interval="2000">
                            <center>
                                ...
                                <h4 class="mt-3"><b>Maria Kate</b></h4>
                                <p class="w-75 text-muted">Saya sangat puas dengan hasil website</p>
                            </center>
                        </div>
                        <div class="carousel-item rounded p-5 bg-dark text-white" data-interval="2000">
                            <center>
                                <div class="imgbox "><img class="rounded-circle border p-2" width="140" height="130" src="../assets/testi2.jpg"></div>
                                <h4 class="mt-3"><b>Anna Deynah</b></h4>
                                <p class="w-75 text-muted">Saya sangat puas dengan pelayanannya yang cepat</p>
                            </center>
                        </div>
                        <div class="carousel-item rounded p-5 bg-dark text-white" data-interval="2000">
                            <center>
                                <div class="imgbox "><img class="rounded-circle border p-2" width="140" height="130" src="../assets/testi3.jpg"></div>
                                <h4 class="mt-3"><b>Pandu</b></h4>
                                <p class="w-75 text-muted">Mantap dewarangga</p>
                            </center>
                        </div>
                    </div>
